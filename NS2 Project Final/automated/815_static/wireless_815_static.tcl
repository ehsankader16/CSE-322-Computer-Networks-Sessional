if {$argc != 5} {
    puts "Usage: ns <aqmrd?> <number_of_nodes> <number_of_flows> <packets_per_sec> <coverage area coefficient>"
    exit 1
}
...
set val(coverageConstant)     [lindex $argv 4]
set val(ny)           [expr {$val(nn)/$val(nx)}]
set val(energymodel)   EnergyModel
set val(initialenergy) 6.0                     
set val(qthresh)       16
